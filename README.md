...
`docker build -t feliperuhland/smart-home-dashboard:latest .`

## Executing with Docker

Using local image:

`docker run --rm -it -p 8080:8080 <docker-image-name>:<tag>`

Using docker hub image:

`docker run --rm -it -p 8080:8080 feliperuhland/smart-home-dashboard:latest`
